...
<div id="navbarcontainer">
  <Nav>
    <Nav.Link href="/" className="mr-1">
      <div className="logo">
        <h2 className="bold">ELAINE SABINE</h2>
      </div>
    </Nav.Link>
  </Nav>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav>
               ...
               <Nav.Link href="http://www.linkedin.com/in/elainesabine" className="mr-1">
               ...
               <Nav.Link href="http://www.github.com/elainesabine" className="mr-1">
                 <img src={github} className="socials-logo"/>
               </Nav.Link>
               <Nav.Link href="http://www.instagram.com/elainesabine" className="mr-1">
