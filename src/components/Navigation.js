      ...
      <div id="navbarcontainer">
        <Nav>
          <Nav.Link href="/" className="mr-1">
            <div className="logo">
              <p className="bold dark-brown mb-0">ELAINE SABINE</p>
            </div>
          </Nav.Link>
        </Nav>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="/" className="mr-1">
              <p className="bold dark-brown mb-0">ABOUT ME</p>
            </Nav.Link>
            <Nav.Link href="/" className="mr-1">
              <p className="bold dark-brown mb-0">EXPERIENCE</p>
            </Nav.Link>
            <Nav.Link href="/" className="mr-1">
              <p className="bold dark-brown mb-0">PROJECTS</p>
            </Nav.Link>
            <Nav.Link href="/" className="mr-1">
              <p className="bold dark-brown mb-0">CLUBS</p>
            </Nav.Link>
          </Nav>
          <Nav>
